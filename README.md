...
1. Open appsettings.json and populate it with the following code (change the variables if you're using a different blockchain):
   ```json
   {
       "Settings": {
...
1. Install webpack `npm install --global webpack`
